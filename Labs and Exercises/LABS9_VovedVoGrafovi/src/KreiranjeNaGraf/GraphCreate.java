    ...
    public static void main(String[] args) throws IOException {
        ...
        while (input != null) {
            ...
            switch (command) {
                ...
                case "ADDEDGE":
                    Objects.requireNonNull(graph).addEdge(Integer.parseInt(splits[1]), Integer.parseInt(splits[2]));

                    break;

                case "PRINTMATRIX":
                    for (int i = 0; i < Objects.requireNonNull(graph).getNum_nodes(); i++) {
                ...
                case "PRINTNODE":
                    System.out.println(Objects.requireNonNull(graph).get_node_value(Integer.parseInt(splits[1])));

                    break;

                case "ADJACENT":
                    System.out.println(Objects.requireNonNull(graph).adjacent(Integer.parseInt(splits[1]), Integer.parseInt(splits[2])));

                    break;

                case "DELETEEDGE":
                    Objects.requireNonNull(graph).deleteEdge(Integer.parseInt(splits[1]), Integer.parseInt(splits[2]));
